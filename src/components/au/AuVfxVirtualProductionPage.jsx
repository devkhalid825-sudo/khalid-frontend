...
const AuVfxVirtualProductionPage = () => {
  const config = {
    navLinks: NAV_LINKS,
    navCta: NAV_CTA,
    marquee: MARQUEE,
    stats: [
      { number: 'Broadcast', label: 'Grade delivery for Australian TV & streaming' },
      { number: '9+', label: 'Years producing CGI & real-time environments' },
      { number: 'AEST', label: 'Sydney studio, Australian hours' },
      { number: '3', label: 'Global delivery hubs' },
    ],
    gallery: VFX_GALLERY,
    hero: {
      eyebrow: 'Home › Australia › Services › VFX & Virtual Production AU',
      title: 'VFX and virtual production for Australian campaigns that need to look bigger than the budget.',
      lead: 'CGI integration, environment replacement, product placement, and real-time LED volume production support — broadcast-grade visual effects for Australian brand campaigns, commercials, and digital content. AUD pricing.',
      actions: true,
      stats: [
    ...
    capabilities: {
      head: {
        ...
        sub: 'A production team that builds the 3D assets and real-time environments your VFX and virtual production shoot needs, on an Australian broadcast timeline.',
      },
      items: [
        { title: 'CGI Integration Australia', desc: 'Photoreal 3D elements composited into live-action footage — products, environments, or effects that were never on set.' },
        { title: 'Environment Replacement', desc: 'Full digital environment and set extension work for Australian commercials and brand films shot on a limited physical set.' },
        { title: 'Product Placement & Integration AU', desc: 'Digitally inserted or replaced product shots for campaigns needing multiple SKU or market variants from one shoot.' },
        ...
        { title: 'Compositing & Nuke Finishing', desc: 'Broadcast-grade compositing, clean-up, and colour finishing for Free TV Australia, BVOD, and digital delivery.' },
        { title: 'AU Office — AEST Production Support', desc: 'Sydney-based production liaison on AEST hours for the length of your shoot and post schedule.' },
      ],
    },
    showcase: [
      {
        eyebrow: 'Why Australian Production Teams Partner With Us',
        title: 'The 3D team behind the visual effects, not just the render.',
        body: 'We work as an extension of your production or agency team — building the 3D assets and real-time environments that make virtual production and VFX-heavy campaigns possible on an Australian broadcast timeline.',
        checklist: [
          ...
          'Delivered to Free TV Australia and BVOD platform technical specifications',
        ],
    ...
    process: {
      ...
      steps: [
        { title: 'Brief & Shoot Plan', desc: 'We review the script, shot list, and production schedule to scope VFX or virtual production needs. Free AUD estimate within 24 AEST business hours.' },
        ...
        { title: 'AU Delivery', desc: 'Free TV Australia or BVOD-spec masters delivered on the agreed post-production schedule.' },
      ],
    },
    testimonials: true,
    faq: {
      head: { eyebrow: 'FAQ', title: 'Questions Australian production teams ask before booking.' },
      items: [
    ...
    contact: {
      ...
      sub: 'Get a free scope call for your Australian production — no commitment required.',
      interests: ['CGI Integration', 'Environment Replacement', 'LED Volume Production', 'Compositing & Finishing', 'Something Else'],
    },
    cta: { title: 'Get a free AUD estimate for your Australian VFX or virtual production project.', body: 'No commitment. Free scope call for qualifying productions.' },
  };

  return <AuPage config={config} />;
};

export default AuVfxVirtualProductionPage;
